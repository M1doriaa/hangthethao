            ...
            <div class="row g-3 align-items-center">
                ...
                <div class="col-lg-3 col-md-3">
                    <select class="form-select form-select-lg" name="category">
                        ...
                        <option value="ao-clb" {{ $category == 'ao-clb' ? 'selected' : '' }}>
                            <i class="fas fa-tshirt me-2"></i>Áo CLB
                        </option>
                        ...
                        <option value="phu-kien" {{ $category == 'phu-kien' ? 'selected' : '' }}>
                            <i class="fas fa-football-ball me-2"></i>Phụ Kiện
                        </option>
                    </select>
                </div>
                ...
                <div class="col-lg-2">
                    <div class="d-flex justify-content-end gap-2">
                        <button class="btn btn-outline-secondary active" id="grid-view-btn" title="Xem dạng lưới">
                            <i class="fas fa-th"></i>
                        </button>
                        <button class="btn btn-outline-secondary" id="list-view-btn" title="Xem dạng danh sách">
